...
dat <- qread(file.path(dir_input, "PGx_corrected_gse_rna_sts.qs"))
...
qsave(res_all, file=  file.path(dir_output, "pgx_rna_celligner_sts_pcs.qs"))

################################################################################
## visualization Part 1
################################################################################

dat <- qread(file.path(dir_output, "pgx_rna_celligner_sts_pcs.qs"))
...
ggsave(paste(paste(dir_output, "optimal_rna_sts_k", sep="") ,".pdf" , sep=""), 
       width = 4, height = 4)
...
pdf(file= file.path(dir_output, "cpca_sts_variance.pdf"), width = 5, height = 5)
