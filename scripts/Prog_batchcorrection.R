...
dir_output <- '/home/bioinf/bhklab/farnoosh/STS-PGx-Biomarker/result/data'

########################################################
# GEO data: assess potential batches across datasets
########################################################
# part I: distribution of studies
dat <- qread(file.path(dir_input, "PGx_gse_rna_sts.qs"))
...
pdf(file= file.path(dir_output, "pca_gse_cohort_before_correction.pdf"), width = 5, height = 5)
...
pdf(file= file.path(dir_output, "pca_gse_subtype_before_correction.pdf"), width = 5, height = 5)
...
pdf(file= file.path(dir_output, "pca_gse_cohort_after_correction.pdf"), width = 5, height = 5)
...
pdf(file= file.path(dir_output, "pca_gse_subtype_after_correction.pdf"), width = 5, height = 5)
...
########################################################################
## Merge the data as correctedGEO
########################################################################
...
qsave(dat, file= file.path(dir_input, "PGx_correctedGEO_gse_rna_sts.qs"))
...
dat <- qread(file.path(dir_input, "PGx_correctedGEO_gse_rna_sts.qs"))
...
pdf(file= file.path(dir_output, "pca_pset_study_before_correction.pdf"), width = 5, height = 5)
...
pdf(file= file.path(dir_output, "pca_pset_study_after_correction.pdf"), width = 5, height = 5)
